package com.juacie.viewsonic.data.network
...
interface ApiService {
    ...
    suspend fun svGetTimeByZone(@Query("timeZone") timeZone: String): DateTimeInfo
    ...
    suspend fun svGetTimeByIp(@Query("ipAddress") ipAddress: String): DateTimeInfo
    //endregion
    //==============================================================================================
    //region TimeZone
    ...
    suspend fun svGetTimeZoneList(): List<String>
    ...
    suspend fun svGetZoneInfoByZone(@Query("timeZone") timeZone: String): TimeZoneData
     ...
     */
    @GET("/api/timezone/ip")
    suspend fun svGetZoneInfoByIp(@Query("ipAddress") ipAddress: String): TimeZoneData
    ...
    suspend fun svPostConvertTimeZone(@Body request: Conversion.ConvertRequest): Conversion.Conversion
    ...
    suspend fun svPostTranslate(@Body request: Conversion.TranslationRequest): Conversion.Translation
    ...
    suspend fun svGetWeekdayOfDate(@Path("date") date: String): Conversion.DayOfTheWeekResult
    ...
    suspend fun svGetDayOfYear(@Path("date") date: String): Conversion.DayOfYearResponse
    //endregion
    //==============================================================================================
    //region Calculation
    ...
    suspend fun svPostIncrementCurrentDateTime(@Body request: Calculation.CurrentRequest): Calculation.Calculation
    ...
    suspend fun svPostDecrementCurrentDateTime(@Body request: Calculation.CurrentRequest): Calculation.Calculation
    ...
    suspend fun svPostIncrementCustomDateTime(@Body request: Calculation.CustomRequest): Calculation.Calculation
    ...
    suspend fun svPostDecrementCustomDateTime(@Body request: Calculation.CustomRequest): Calculation.Calculation
    //endregion
    //==============================================================================================
    //region Health
    ...
    suspend fun svGetHealthCheck(): String
    //endregion
    //==============================================================================================
}